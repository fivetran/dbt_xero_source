...
packages:
  - package: fivetran/xero_source
    version: 0.7.0-a1 # we recommend using ranges to capture non-breaking changes automatically
```
...
- If you have questions or want to reach out for help, see the [GitHub Issue](https://github.com/fivetran/dbt_xero_source/issues/new/choose) section to find the right avenue of support for you.
